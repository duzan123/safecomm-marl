...
| Safe Multi-Agent Reinforcement Learning for Price-Based Demand Response | Metadata mismatch | 题名可核验，作者为 Hannah Markgraf and Matthias Althoff，来源为 ICLR 2023 Tackling Climate Change with Machine Learning workshop；未核验到原报告所称 IEEE Transactions on Smart Grid。 | https://s3.us-east-1.amazonaws.com/climate-change-ai/papers/iclr2023/18/paper.pdf；https://ieeexplore.ieee.org/abstract/document/10407281/ | 可作为能源需求响应应用文献，但需按 workshop/IEEE 会议页面元数据引用。 |
...
MAPPO 本身不是安全算法，但 Yu et al. 证明 PPO/MAPPO 在合作 MARL 中是强基线，这解释了为什么 MAPPO-Lagrangian 会成为 Safe MARL 中自然的工程起点。它的价值在于稳定、易复现和 CTDE 训练范式成熟；局限也相同：集中式训练阶段通常假设可访问全局状态或全局观测拼接，通信受限时需要重新定义 critic 输入、代价估计和拉格朗日乘子更新。
...
1. Eitan Altman. "Constrained Markov Decision Processes". Chapman & Hall/CRC, 1999. 来源链接：https://openlibrary.org/books/OL97592M/Constrained_Markov_decision_processes
...
5. Shangding Gu, Jakub Grudzien Kuba, Muning Wen, Ruiqing Chen, Ziyan Wang, Zheng Tian, Jun Wang, Alois Knoll, Yaodong Yang. "Multi-Agent Constrained Policy Optimisation". arXiv:2110.02793, 2021. 来源链接：https://arxiv.org/abs/2110.02793
...
15. Hannah Markgraf, Matthias Althoff. "Safe Multi-Agent Reinforcement Learning for Price-Based Demand Response". Tackling Climate Change with Machine Learning workshop at ICLR, 2023. 来源链接：https://s3.us-east-1.amazonaws.com/climate-change-ai/papers/iclr2023/18/paper.pdf
16. Shangding Gu, Long Yang, Yali Du, Guang Chen, Florian Walter, Jun Wang, Yaodong Yang, Alois Knoll. "A Review of Safe Reinforcement Learning: Methods, Theory and Applications". arXiv:2205.10330, 2022. 来源链接：https://arxiv.org/abs/2205.10330
